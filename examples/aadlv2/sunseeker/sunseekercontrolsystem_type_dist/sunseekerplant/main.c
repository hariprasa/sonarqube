...
/*!
 * Store the period time for task plant
 */
  __po_hi_milliseconds (&(period), 10);
  
/*!
 * \brief Making Periodic Task plant
 *
 ...
 * (sunseekerplant_plant_k) the second is the period defined in the AADL 
 * model. Third is the task priority ( 0), fourth is the stack size ( 0 
 * bytes) and last is the subprogram executed by the task
 */
  __po_hi_create_periodic_task (sunseekerplant_plant_k, &(period), __PO_HI_DEFAULT_PRIORITY, 0, 0, plant_job);
